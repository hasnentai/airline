...
import Discount2 from "../../assets/img/discount-two.jpg";
        ...
        <Row className="pb-2">
          <Col>
            ...
            <div className="flex-wrapper">
                ...
                <div className="display-3 font-weight-light p-2 ">ANA</div>
                <div className="destination font-weight-bolder p-2 ">東京(Tokyo) <span>&#8594;</span> 札幌(Sapporo)</div>
            </div>
            <div >
                <img className="disc-img" src={Discount2} alt="disc-one"/>
            </div>
